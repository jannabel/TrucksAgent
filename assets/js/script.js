...
//$("#ValorCargaC").val(total);
  
        }
      
        function calcularPeso(){
           
          var total=$("#PesoCargaC").val();
          console.log(total);
