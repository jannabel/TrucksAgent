                                            ...
                                            <form action="php/Auth/register.php" method="POST">
                                             ...
                                             <input required class="form-control" type="number" hidden value="<?= $row["IdUsers"]?>" readonly="" name="IdUsers">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <?php
                                                    session_start();
                                                    if($_SESSION["Rol"==0]) $var="disabled";
                                                    ?>
                                                    <input class="form-check-input custom-control-input" <?php echo   ($row["Rol"]==1) ? 'checked="checked"' : 'disabled'; ?> type="checkbox" name="ROL" id="formCheck-1">
